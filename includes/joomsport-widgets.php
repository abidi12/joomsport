  ...
  public function form( $instance ) {
    ...
    <div class="JSshrtPop">
      <div>
        ...
        <?php echo JoomSportHelperSelectBox::Simple($this->get_field_name( 'event_id' ), $ev,$event_id, ' ');?>
      </div>
      <div>
        <label><?php echo __("Select season", "joomsport-sports-league-results-management");?></label>
        <?php $results =  JoomSportHelperObjects::getSeasons(-1);?>
      ...
      <div>
        ...
        <?php echo JoomSportHelperSelectBox::Radio($this->get_field_name( 'display_teamname' ), $lists_radio,$display_teamname, ' ');?>
